...
const T: Record<string, { en: string }> = {
  ...
  "Smakvärlden samlar recept, råvarupriser, kalkyler och svinnanalys i ett arbetsflöde för svenska restauranger.": { en: "Smakvärlden brings recipes, ingredient prices, costing, and waste analysis into one workflow for Swedish restaurants." },
  "Ett digitalt arbetsbord för recept, råvarupriser, marginal och svinn i svenska restauranger.": { en: "A digital workspace for recipes, ingredient prices, margin, and waste in Swedish restaurants." },
  "Dagens fokus":                  { en: "Today's focus" },
  "Bygg din kokbok":               { en: "Build your cookbook" },
  "Se marginal direkt":            { en: "See margin instantly" },
  "Se prisvarningar":              { en: "View price alerts" },
  "Hitta dyra råvaror":            { en: "Find expensive ingredients" },
  "Kontrollera prisvarningar innan du ändrar menyn.": { en: "Check price alerts before changing the menu." },
  "Kalkylera nya rätter innan de publiceras.": { en: "Calculate new dishes before publishing them." },
  "Följ svinn och råvarukostnad varje vecka.": { en: "Track waste and ingredient cost every week." },
  "Inloggad som":                 { en: "Signed in as" },
  "Bygg recept":                  { en: "Build recipes" },
  "Följ priser":                  { en: "Track prices" },
  "Räkna marginal":               { en: "Calculate margin" },
  "Minska svinn":                 { en: "Reduce waste" },
  "Snabbnavigering":              { en: "Quick navigation" },
  "Översikt":                     { en: "Overview" },
  "Aktivitet":                    { en: "Activity" },
  "Ny kalkyl":                    { en: "New calculation" },
  ...
  "Ladda svensk startdata": { en: "Load Swedish starter data" },
  "Laddar startdata...": { en: "Loading starter data..." },
  "Startdata laddad": { en: "Starter data loaded" },
  "ingredienser": { en: "ingredients" },
  "recept": { en: "recipes" },
  ...
  "Svenska matnyheter":        { en: "Swedish food news" },
  "Uppdateras automatiskt från svenska branschkällor": { en: "Automatically updated from Swedish industry sources" },
  "Live":                      { en: "Live" },
  "Nyhetsflödet kunde inte hämtas just nu.": { en: "The news feed could not be loaded right now." },
