...
import { z } from "zod";
import { useUpdateRecipe, getListRecipesQueryKey } from "@workspace/api-client-react";
...
export function EditRecipeDialog({
  ...
  const form = useForm<z.infer<typeof schema>>({
    ...
    defaultValues: {
      ...
      sellingPriceSek: recipe?.sellingPriceSek ?? 0,
        ...
        <Form {...form}>
          ...
          >
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={update.isPending || !recipe}>{t("Spara")}</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
